...
The MCP server is automatically assigned a domain by Coolify through the `SERVICE_FQDN_MCP_3000` environment variable (auto-generated by Coolify). This makes it accessible via HTTPS at your Coolify domain.
